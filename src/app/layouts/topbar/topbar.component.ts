...
export class TopbarComponent {
  ...
  constructor(@Inject(DOCUMENT) private document: Document & FullScreenTypes,private cartService: CartService) {
  ...
  cart(){
    // Si 'panier' est un chemin simple déclaré dans ton routing
